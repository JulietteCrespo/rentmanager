...
public class ClientCreateServlet extends ClientListServlet {
    ...
    ValidatorClient validateurClient;
    @Autowired
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (validateurClient.si_non_majeur(client) && validateurClient.taille_nom_prenom(client)){
                if (validateurClient.email_valide(client)){
